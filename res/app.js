...
function displayRepositories(repos) {
    ...
    nonForkRepos.forEach((repo, index) => {
        ...
        title.innerHTML = repo.name +
            getCategoryIcon(repo.topics.includes("game") || repo.name.includes("game"), "game") +
            ...
            getCategoryIcon(repo.topics.includes("example") || repo.topics.includes("learning") || repoDescLower.includes("example of") || repoDescLower.includes("learn") || repoDescLower.includes("study") || repoDescLower.includes("tutorial"), "learn") +
            getCategoryIcon(repo.topics.includes("web") || repoDescLower.includes("web-") || repoDescLower.includes("html") || repoDescLower.includes("css"), "web") + getCategoryIcon(repo.topics.includes("optimizer") || repoDescLower.includes("cleanup") || repoDescLower.includes("clean up") || repoDescLower.includes("optimization") || repoDescLower.includes("optimize "), "leaf") +
            getCategoryIcon(repo.topics.includes("sorter") || repo.topics.includes("detector") || repo.topics.includes("scanner") || repoDescLower.includes("sort") || repoDescLower.includes(" collection") || repoDescLower.includes("database"), "database") +
            getCategoryIcon(repo.topics.includes("protection") || repoDescLower.includes("protect") || repoDescLower.includes("obfuscat"), "shield") +
            getCategoryIcon(repo.topics.includes("library"), "sdk") +
